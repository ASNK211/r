        ...
        <ul class="mt-12">
          ...
          >
            <div class="flex items-center">
              ...
              <router-link to="/admin/adminwllet"
                ><span class="text-sm ml-2">adminwllet</span></router-link
              >
            </div>
            <div
          ...
          >
            <div class="flex items-center">
              ...
              <router-link to="/admin/product" href="#!"
                ><span class="text-sm ml-2">Products</span></router-link
              >
            </div>
            <div
              class="py-1 px-3 bg-gray-700 rounded text-gray-500 flex items-center justify-center text-xs"
          ...
          >
            <div class="flex items-center">
              ...
              <router-link to="/admin/adminUsers" href="#!"
                ><span class="text-sm ml-2">users</span></router-link
              >
            </div>
          </li>
          <li
          ...
          >
            <div class="flex items-center">
              ...
              <router-link to="/admin/adminOrder" href="#!"
                ><span class="text-sm ml-2">order</span></router-link
              >
            </div>
          </li>
          <li
          ...
          >
            <div class="flex items-center">
              ...
              <router-link to="/admin/card" href="#!"
                ><span class="text-sm ml-2">card</span></router-link
              >
            </div>
            <div
              class="py-1 px-3 bg-gray-700 rounded text-gray-500 flex items-center justify-center text-xs"
          ...
          >
            <div class="flex items-center">
              ...
              <router-link to="/admin/reorder" href="#!"
                ><span class="text-sm ml-2">reorder</span></router-link
              >
            </div>
          </li>
          <li
